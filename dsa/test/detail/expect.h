...
static void print_failure_msg(const std::string &expr, const T &actual,
                              const U &expected, const std::string &fileName,
                              int32_t lineNumber) {
  std::cerr << "[   ✗ FAIL   ] " << expr << " @ " << fileName << ":"
            << lineNumber << "\n";
...
template <class T, class U>
static void print_success_msg(const std::string &expr, const T &actual,
                              const U &expected, const std::string &fileName,
                              int32_t lineNumber) {
  std::cout << "[   ✓ PASS   ] " << actual << expr << expected << " @ "
            << fileName << ":" << lineNumber << "\n";
  testing::test_results::instance().pass_check();
}

template <class T>
static void expect(const T &condition, const std::string &fileName,
                   int32_t lineNumber) {
  if (condition) {
...
template <class T, class U>
static void expect_ne(const T &actual, const U &expected,
                      const std::string &fileName, int32_t lineNumber) {
  if (actual == expected) {
...
template <class T, class U>
static void expect_le(const T &actual, const U &expected,
                      const std::string &fileName, int32_t lineNumber) {
  if (actual > expected) {
...
template <class T, class U>
static void expect_ge(const T &actual, const U &expected,
                      const std::string &fileName, int32_t lineNumber) {
  if (actual < expected) {
...
template <class T, class U>
static void expect_lt(const T &actual, const U &expected,
                      const std::string &fileName, int32_t lineNumber) {
  if (actual >= expected) {
...
template <class T, class U>
static void expect_gt(const T &actual, const U &expected,
                      const std::string &fileName, int32_t lineNumber) {
  if (actual < expected) {
